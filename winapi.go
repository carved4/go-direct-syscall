...
// FormatNTStatus returns a formatted string representation of an NTSTATUS code
// with both the hex value and human-readable description
func FormatNTStatus(status uintptr) string {
	...
	// For unknown status codes, try to categorize them
